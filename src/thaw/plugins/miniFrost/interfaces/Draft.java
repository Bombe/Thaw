...
public interface Draft {
	...
	/**
	 * Returned result may contains $sender$, $dateAndTime$. They will be
	 * replaced.
	 *
	...
	/**
	 * @param i
	 * 		specify the position of the id line in the text
	 */
	public void setIdLinePos(int i);

	/**
	 * @param i
	 * 		specify the length of the id line in the text
	 */
