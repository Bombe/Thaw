...
public class Logger {
	...
	/**
	 * 0 = Errors only 1 = Errors + warnings 2 = Errors + warnings + notices 3 =
	 * Errors + warnings + notices + infos 4 = Errors + warnings + notices + infos
	 * + debug 5 = [...] + horrible things that only God could understand easily.
	 * (or maybe someone with the FCPv2 specs :)
	 * <p/>
	 * 2 or more is recommended. 4 or more is unhealthy
	 */
	...
	/** Errors. A process ended because of it. */
	public static void error(final Object o, final String message) {
		log(0, o, message);
	}

	/**
	 * Warnings. Some informations will probably be / are probably missing. Or:
	 * Can't do something, but it's normal.
	 */
	...
	/**
	 * Notices. Strange event, but probably not unusual. Or: Normal event, but who
	 * can create troubles.
	 */
