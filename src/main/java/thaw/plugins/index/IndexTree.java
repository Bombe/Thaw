...
public class IndexTree extends Observable implements MouseListener, ActionListener, TreeSelectionListener {
	...
	/**
	 * @param queueManager
	 * 		Not used if selectionOnly is set to true
	 * @param config
	 * 		Not used if selectionOnly is set to true (used for
	...
	/**
	 * Will find the corresponding index and all its parents, then will unfold the
	 * tree according to the path to reach the index and then select the index.
	 * (won't touch filetable / linktable)
	 */
