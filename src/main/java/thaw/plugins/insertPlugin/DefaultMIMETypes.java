...
public class DefaultMIMETypes {
	...
	/**
	 * MIME types by extension. One extension maps to one MIME type, but not
	 ...
	 *
	 * @param number
	 * 		The number of the MIME type for compression. This *must not change* for a
	 * 		given type, or the metadata format will be affected.
	 * @param type
	 ...
	 * 		parameters and there is a separate mechanism for them.
	 * @param extensions
	 * 		An array of common extensions for files of this type. Must be unique for
	 * 		the type.
	 */
