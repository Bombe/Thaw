...
public class SentMessages
	...
	/**
	 * don't store/cache the messages, just give them.
	 *
	 * @param keywords
	 * 		can be null
	 * @param orderBy
	 ...
	 * @param desc
	 * @param archived
	 * 		If true, archived messages will also be returned
	 */
	...
	/**
	 * must refresh() the board list each time a new message is found and when the
	 * refresh is finished. MUST NOT BE BLOCKING.
	 */
	public void refresh() {
		return;
	}
	...
	/** Always return the board name, without anything more */
